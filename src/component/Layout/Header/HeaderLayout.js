...
import { avt, logo, vn, en } from "../../../constants/images";
  ...
  return (
    <>
      ...
      >
        ...
        />
        <label htmlFor="navbar-check" className="navbar-overlay"></label>

        <div className="navbar-mobile">
          <label htmlFor="navbar-check" className="navbar-mobile-exit">
                ...
                <ul className="list-info">
                  ...
                  <li>
                    <div class="box-list-info">
                      ...
                      <Link to="/thanh-toan">Xu của tôi</Link>
                    </div>
                  </li>
                  <li>
